...
void yuanshen_qd()//不管
{
    ...
    lv_anim_set_values(&ys_ani,0,240);
...
void Start_UP()
{
    ...
    lv_obj_set_style_border_color(cont, lv_color_hex(0x93C4EC), 0);
    ...
    lv_anim_set_time(&start_up,1200);
    ...
    lv_obj_set_style_text_font(label, &font_agencyb_36, 0);
    lv_obj_set_style_text_color(label, lv_color_white(), 0);
    lv_label_set_text(label, "X-TARCK");
//    lv_obj_set_style_text_font(label,&font_agencyb_36, 0);
    lv_obj_center(label);
